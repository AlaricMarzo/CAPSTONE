...
# -*- coding: utf-8 -*-
"""
Classical TS (ETS, SARIMA, SARIMAX, Holt-Winters, Seasonal-Naive, Blend) with:
- Top-10 best-sellers (coverage-aware) → top10_bestsellers.csv
- Fixed 80/20 holdout + Rolling-origin CV (expanding) model selection (MASE; tiebreak WAPE, RMSE)
- Robust pre-processing (STL outlier dampening + winsorize, auto log1p if skewed)
- Past/Present/Future bands; connected Selected Forecast (holdout→future)
- Legend outside; compact metrics table
- Croston-SBA path for intermittent series (vs Seasonal-Naive baseline)
"""
